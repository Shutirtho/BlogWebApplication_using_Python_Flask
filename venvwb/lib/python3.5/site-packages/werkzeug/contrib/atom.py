        ...
        def atom_feed(request):
            ...
            for post in Post.query.limit(10).all():
                feed.add(post.title, post.body, content_type='html',
                         author=post.author, url=post.url, _id=post.uid,
...
class AtomFeed(object):
    ...
    :param id: a globally unique _id for the feed.  Must be an URI.  If
    ...
    def __init__(self, title=None, entries=None, **kwargs):
        ...
        self.id = kwargs.get('_id', self.feed_url)
...
class FeedEntry(object):
    ...
    :param id: a globally unique _id for the entry.  Must be an URI.  If
    ...
    def __init__(self, title=None, content=None, feed_url=None, **kwargs):
        ...
        self.url = kwargs.get('url')
        self.id = kwargs.get('_id', self.url)
        self.updated = kwargs.get('updated')
